...
func TestReqRespProtocolIDsMatchCrossClient(t *testing.T) {
	...
	// BlocksByRootProtocol must match the leanSpec-defined protocol ID.
	...
	if reqresp.BlocksByRootProtocolLegacy != "/leanconsensus/req/lean_blocks_by_root/1/ssz_snappy" {
