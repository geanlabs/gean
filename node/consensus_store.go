...
// which stores the full SignedBlock SSZ.
...
// Body in BlockBodies, full SignedBlock in BlockSignatures.
func writeBlockData(s *ConsensusStore, root [32]byte, signedBlock *types.SignedBlock) {
	...
	// Store full SignedBlock (includes proposer attestation + signatures).
